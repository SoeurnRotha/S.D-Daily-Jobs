      ...
      children: [
        ...
        Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage("images/jobs/Sele real estate.jpg"),
                      fit: BoxFit.cover
                  )
              ),
            ),
            ...
            Container(
              alignment: Alignment.center,
              child: Text("Sele Real Estate",style: TextStyle(fontFamily: "f1",fontSize: 30),),
            ),
            SizedBox(height: 20,),
            Container(
              alignment: Alignment.center,
              child: Text("\$250 - \$350",style: TextStyle(fontSize: 20),),
            ),
            SizedBox(height: 20,),
            Container(
              alignment: Alignment.center,
