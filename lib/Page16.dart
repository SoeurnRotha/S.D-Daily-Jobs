      ...
      children: [
        ...
        Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage("images/jobs/Interior Design.jpg"),
                      fit: BoxFit.cover
                  )
              ),
            ),
            ...
            Container(
              alignment: Alignment.center,
              child: Text("Interior Designer",style: TextStyle(fontFamily: "f1",fontSize: 30),),
            ),
            SizedBox(height: 20,),
            Container(
              alignment: Alignment.center,
              child: Text("\$400 - \$500",style: TextStyle(fontSize: 20),),
            ),
            SizedBox(height: 20,),
            Container(
              alignment: Alignment.center,
