...
class _Page11State extends State<Page11> {
  ...
  get _appbar=>AppBar(
    ...
    title: Text("Retail Sales Manager"),
  );
      ...
      children: [
        ...
        Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage("images/jobs/Retail Sales Manager.jpeg"),
                      fit: BoxFit.cover
                  )
              ),
            ),
            ...
            Container(
              alignment: Alignment.center,
              child: Text("Retail Sales Manager",style: TextStyle(fontFamily: "f1",fontSize: 30),),
            ),
            SizedBox(height: 20,),
            Container(
              alignment: Alignment.center,
              child: Text("\$1000 - \$1500",style: TextStyle(fontSize: 20),),
            ),
            SizedBox(height: 20,),
            Container(
              alignment: Alignment.center,
