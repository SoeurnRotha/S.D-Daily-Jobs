      ...
      children: [
        ...
        Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage("images/jobs/Sele showroom.jpg"),
                      fit: BoxFit.cover
                  )
              ),
            ),
            ...
            Container(
              alignment: Alignment.center,
              child: Text("Sele showroom",style: TextStyle(fontFamily: "f1",fontSize: 30),),
            ),
            SizedBox(height: 20,),
            Container(
              alignment: Alignment.center,
              child: Text("\$180 - \$200",style: TextStyle(fontSize: 20),),
            ),
            SizedBox(height: 20,),
            Container(
              alignment: Alignment.center,
